		...
		package: {
			...
			intro: (function () {
				var log = [
					...
					'仓库链接：',
					'<a download href="https://hub.fgit.ml/Tipx-L/decade-ui" target="_blank">https:<wbr>//<wbr>hub<wbr>.fgit<wbr>.ml<wbr>/Tipx<wbr>-L<wbr>/decade<wbr>-ui</a>',
					'<a download href="https://github.com/Tipx-L/decade-ui" target="_blank">https:<wbr>//<wbr>github<wbr>.com<wbr>/Tipx<wbr>-L<wbr>/decade<wbr>-ui</a>',
					'最新版下载链接：',
